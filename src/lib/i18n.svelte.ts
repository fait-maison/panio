...
const translations = {
	en: {
		...
		'style.samba': 'samba',
		// style training pages
		'style.title': 'Style Training',
		'style.comingSoon': 'Coming soon',
		'style.play': 'Play',
		'style.stop': 'Stop',
		'style.bpm': 'BPM',
		'style.key': 'Key',
		'style.notation': 'Notation',
		'style.beatGrid': 'Beat grid',
		'style.bass': 'Bass',
		'style.chord': 'Chord',
	...
	fr: {
		...
		'style.samba': 'samba',
		// style training pages
		'style.title': 'Entraînement aux styles',
		'style.comingSoon': 'Bientôt disponible',
		'style.play': 'Jouer',
		'style.stop': 'Arrêter',
		'style.bpm': 'BPM',
		'style.key': 'Tonalité',
		'style.notation': 'Notation',
		'style.beatGrid': 'Grille rythmique',
		'style.bass': 'Basse',
		'style.chord': 'Accord',
